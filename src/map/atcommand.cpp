...
ACMD_FUNC(go)
{
	...
	const struct {
		...
		{ MAP_GEFFEN,      119,  67 }, //  2=Geffen
		{ MAP_PAYON,       173, 106 }, //  3=Payon
		{ MAP_ALBERTA,     31, 234 }, //  4=Alberta
#ifdef RENEWAL
		{ MAP_IZLUDE,      128, 146 }, //  5=Izlude (Renewal)
#else
		{ MAP_IZLUDE,      128, 90 }, //  5=Izlude
#endif
		{ MAP_ALDEBARAN,   140, 115 }, //  6=Al de Baran
		{ MAP_LUTIE,       147, 130 }, //  7=Lutie
		{ MAP_COMODO,      188, 153 }, //  8=Comodo
		{ MAP_YUNO,        149,  182 }, //  9=Yuno
		{ MAP_AMATSU,      110,  153 }, // 10=Amatsu
		{ MAP_GONRYUN,     160, 120 }, // 11=Gonryun
		{ MAP_UMBALA,       89, 157 }, // 12=Umbala
		{ MAP_NIFLHEIM,     21, 153 }, // 13=Niflheim
		{ MAP_LOUYANG,     217,  103 }, // 14=Louyang
#ifdef RENEWAL
		{ MAP_NOVICE,       18, 26  }, // 15=Training Grounds (Renewal)
#else
		{ MAP_NOVICE,       161, 20 }, // 15=Training Grounds
#endif
		...
		{ MAP_EINBECH,      173,  127 }, // 21=Einbech
		{ MAP_HUGEL,        96, 145 }, // 22=Hugel
		{ MAP_RACHEL,      120, 138 }, // 23=Rachel
		{ MAP_VEINS,       216, 123 }, // 24=Veins
		{ MAP_MOSCOVIA,    221, 192 }, // 25=Moscovia
		...
		{ MAP_SEAL,     81, 88 }, // 37=Seal City
		{ MAP_BG,     153, 149 }, // 38=Battleground
		{ MAP_VENDING,     99, 99 }, // 39=Zona Merchant
	};
	...
	if (strncmp(map_name, "prontera", 3) == 0) {
		...
		town = 36;
	} else if (strncmp(map_name, "seal", 3) == 0) {        
	town = 37;	
	} 
