...
enum _sp {
	...
	SP_ITEMUSEDCARD3 = 114, //Aglao - Definición de Asignacion de valor Card3 al item consumido
	SP_ITEMUSEDQUANTITY = 115, //Aglao - Definición de Asignacion de valor Quantity del item consumido
	SP_ITEMUSEDCARD2 = 116, //Aglao - Definición de Asignacion de valor Card2 al item consumido
    SP_ITEMUSEDID = 117,
	SP_KILLEDGID=118,
