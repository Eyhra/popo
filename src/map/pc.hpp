...
#define MISSION_TICK "Mission_Tick"
...
struct map_session_data {
	...
	int killerrid, killedrid, killedgid, itemusedid, itemusedcard2, itemusedcard3, itemusedquantity; //Aglao - Declaración de variable para valor card2, card3 y quantity del item consumido
