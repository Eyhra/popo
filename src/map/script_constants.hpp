...
#define SCRIPT_CONSTANTS_HPP
	...
	export_parameter("itemusedcard2", SP_ITEMUSEDCARD2); //Aglao - Definición de Constante Asignacion de valor Card2 al item consumido
	export_parameter("itemusedcard3", SP_ITEMUSEDCARD3); //Aglao - Definición de Constante Asignacion de valor Card3 al item consumido
	export_parameter("itemusedquantity", SP_ITEMUSEDQUANTITY); //Aglao - Definición de Constante Asignacion de valor Quantity al item consumido
